 ...
 */
class StrategyDenisTest extends KernelTestCase
{
    /**
     * @var \App\BinanceBot\Trading\StrategyDenis
     */
    private $testObj;
    ...
    {
        self::bootKernel();
        $this->strategy = self::$container->get(StrategyDenis::class);
    }

    /**
     * @dataProvider candleStickDataProvider
     * @covers       \App\BinanceBot\Trading\StrategyDenis::execute
     *
     * @param $candlesticks
     */
